...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The cojin developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "cojin"
...
#define PACKAGE_BUGREPORT "https://github.com/cojin/cojin"

/* Define to the full name of this package. */
#define PACKAGE_NAME "cojin"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "cojin 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "cojin.org"
